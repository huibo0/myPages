        ...
        <div class="primary col-md-8 col-sm-12 col-xs-12">
            <section class="about section">
                <div class="section-inner">
                    ...
                    <div class="content">
                        <p>本项目采取了08cms的官方框架，后台管理功能非常多，有自己独特的框架标准，网站的总体运行环境为windows server2012+apache+mysql，环境为phpstuday控制，操作简单。</p>

                        <p>本网站我负责管理后台部分和增加新的页面，在这个过程当中熟悉了这个框架，这个框架当中有标记来控制网站识别页面，路由功能，结构比起微擎可以说清晰很多。</p>
                ...
                <div class="section-inner">
                    ...
                    <div class="content">
                        ...
                        <div class="item featured text-center">
                            <h3 class="title"><a href="http://wanghouses.com" target="_blank">旺屋</a></h3>
                            <p class="summary">基于08cms房产系统的二开</p>
                            <div class="featured-image">
                                <a href="http://wanghouses.com" target="_blank">
                                    <img class="img-responsive project-image" src="{{asset('images/wangwu2.png')}}" alt="project name" />
                                </a>
                                <div class="ribbon">
                            ...
                            <div class="desc text-left">
                                <p>本项目我主要负责维护，以及修复常规bug，修复的bug包括页面无法正常显示，服务器错误530，增加了几部分常规页面，本网站后台功能很强大基本可以实现大部分功能。</p>

                            </div><!--//desc-->
                            <img class="img-responsive project-image" src="{{ asset('images/wangwu1.png') }}" alt="project name" />

                            <a class="btn btn-cta-secondary" href="http://sh.100haofang.cn" target="_blank"><i class="fa fa-thumbs-o-up"></i> 前往项目 </a>
                        </div><!--//item-->
